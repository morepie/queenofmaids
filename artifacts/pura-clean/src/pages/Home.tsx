...
const homepageFaqs = [
  ...
  { q: 'Do you bring your own supplies?', a: "Yes! Our teams bring all supplies and professional-grade equipment to every visit. We use eco-friendly, non-toxic products safe for kids, pets, and the environment. If you have preferred products or allergies, just let us know and we'll accommodate." },
