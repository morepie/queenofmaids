  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 prose prose-sm sm:prose-base prose-headings:text-foreground prose-p:text-foreground/80 prose-li:text-foreground/80 prose-strong:text-foreground">
        ...
        <p>As we continue to develop our business, we might become involved in financing transactions or business transactions involving the sale or license of our assets or business units. In either case, User Information often is disclosed on a confidential basis or is one of the transferred business assets but remains subject to the promises made in any pre-existing Privacy Policy (unless, of course, the User consents otherwise). Also, in the event Queen of Maids is merged with another company or acquired, or substantially all of its assets are acquired, User Information will be one of the transferred assets.</p>
        <p><strong>Protection of Queen of Maids and Others:</strong> We also may be required to disclose an individual's personal information in response to a lawful request by public authorities, including to meet national security or law enforcement requirements. This includes exchanging information with other companies and organizations for fraud protection and credit risk reduction. This does not, however, include selling, renting, sharing, or otherwise disclosing personally identifiable information from Users for commercial purposes in violation of the commitments set forth in this Privacy Policy.</p>
