...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    longDescription: 'Our Weekly Cleaning plan is the ultimate in home maintenance. Every week, on the same day, your dedicated cleaner arrives and handles everything — so you never have to think about cleaning again. All standard tasks are covered: dusting, vacuuming, mopping, bathrooms, kitchen, trash, and tidying. Plus, your cleaner saves your custom preferences and handles any special requests. Weekly clients enjoy our best per-visit pricing, priority scheduling, and first access to add-on services. It\'s the most hands-off way to enjoy a perfectly clean home.',
    benefits: ['Best per-visit pricing of any plan', 'Truly hands-off home maintenance', 'Home is always company-ready', 'Custom preferences remembered', 'Priority access to add-on services'],
