...
export const services: ServiceData[] = [
  {
    ...
    benefits: ['Consistent, reliable results every visit', 'Detailed checklist ensures nothing is missed', 'Professional-grade cleaning products', 'Dedicated cleaner assigned to your home', 'Flexible scheduling options'],
  ...
  },
  {
    ...
    description: 'Moving into a new place? Our Move In Cleaning ensures your new home is spotless before you unpack. We clean every inch, including inside cabinets, closets, all appliances, bathrooms, and every surface, so you can settle in with confidence knowing your space is perfectly clean.',
  ...
  },
  {
    ...
    description: 'Moving out? Our Move Out Cleaning ensures you leave the property in pristine condition to help you get your full security deposit back. We handle the deep cleaning of every room, inside all cabinets and appliances, and make sure the home looks better than when you moved in.',
